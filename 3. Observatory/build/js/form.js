...
function initForm() {
    ...
    // TODO
    var calendarField = document.getElementsByClassName("form__label__input date")[0];
    calendarField.addEventListener("click", function() {
        var calendar = document.getElementsByClassName("jsCalendar")[0];
        calendar.style.width = calendarField.offsetWidth + "px";
        console.log(calendar.style.offsetleft);
        calendar.style.left = calendar.style.offsetleft + 4 + "px";
        console.log(calendar.style.offsetleft);
    });
